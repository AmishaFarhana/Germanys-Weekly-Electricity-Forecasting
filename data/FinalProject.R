...
setwd("/Users/amishafarhanashaik/Desktop/MSBA/BAN673TimeSeries /Project")
...
tot.ma.trail.res <- rollmean(tot.trend.seas.res, k = 52, align = "right")
tot.ma.trail.res
...
####Model 2: Regression model with seasonality
...
# Use trailing MA to forecast residuals for entire data set.
elec.ma.trail.res <- rollmean(elec.trend.seas.res, k = 52, align = "right")
elec.ma.trail.res
